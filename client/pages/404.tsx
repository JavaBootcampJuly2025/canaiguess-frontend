      ...
      <div className="relative z-10 flex items-center justify-center min-h-screen p-4">
        <div className="text-center space-y-8 max-w-md">
          ...
          <div className="space-y-4">
            <div className="text-8xl font-bold bg-gradient-to-r from-neural-purple to-electric-blue bg-clip-text text-transparent">
              404
            </div>
          ...
          <Button
            asChild
            className="bg-gradient-to-r from-ai-glow to-electric-blue hover:from-ai-glow/90 hover:to-electric-blue/90 shadow-lg shadow-ai-glow/25 transition-all duration-300"
          >
