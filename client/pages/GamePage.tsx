      ...
      <div className="relative z-10 min-h-screen">
        ...
        <div className="px-6 pb-12">
          <div className="max-w-6xl mx-auto">
            {/* Instructions */}
            <Card className="mb-8 border-border/50 backdrop-blur-sm bg-white/10">
                        ...
                        {isRequestingHint === selectedImageForHint.id ? (
                          <div className="flex flex-col items-center justify-center py-12 space-y-4">
                            ...
                            <div className="text-center">
                              ...
                              <p className="text-sm text-muted-foreground">Our AI is examining the image for authenticity markers</p>
                            </div>
                          </div>
                              ...
                              <div className="flex items-start space-x-2">
                                ...
                                <div className="text-sm">
                                  ...
                                  <div className="text-muted-foreground">
                                    This AI analysis helps you learn detection patterns. Compare these insights with your own observations to improve your skills.
                                  </div>
                                </div>
                              </div>
                            </div>
